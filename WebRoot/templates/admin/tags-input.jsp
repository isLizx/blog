...
<body>
  ...
  <div class="ui attached pointing menu">
    <div class="ui container">
      <div class="right menu">
         <a href="#" class="teal active item">${tag.id eq null ? '新增':'修改' }</a>
        <a href="${pageContext.request.contextPath }/templates/admin/tag_listpage.action" class="teal item">列表</a>
      </div>
    </div>
  </div>
  ...
  <div  class="m-container-small m-padded-tb-big">
    <div class="ui container">
      <form action="${pageContext.request.contextPath }/templates/admin/tag_update.action" method="post" class="ui form">
        <input type="hidden" name="tag.id" value="${tag.id }">
        <input type="hidden" name="currentPage" value="${currentPage }" />
        <div class=" field">
          <div class="ui left labeled input">
            <label class="ui teal basic label">名称</label>
            <input type="text" name="tag.name" placeholder="标签名称" value="${tag.name }">
          </div>
        </div>
